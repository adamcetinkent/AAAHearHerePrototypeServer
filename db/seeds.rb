...
post01 = Post.create!(user_id: '1',   track: '2Iccm3cKBQHWt5yk0yX9nh', 
                      ...
                      dummy_lat:'51.5283987',  dummy_lon: '-0.1297568',
                      message: 'First post! omg!',
                      place_name: "Pret a Manger, King's Cross, London",
                      privacy: '0',
                      created_at: '2016-01-30 08:03:50.50')
post02 = Post.create!(user_id: '2',   track: '5UJ8StM1nvIJJRhK5gEAJc',
											lat:			'51.5326212',		lon:			'-0.1272544',
											dummy_lat:'51.5343368',		dummy_lon:'-0.1259262',
                      message: 'LOVE THIS TUNE!',
                      place_name: "Starbucks, King's Cross",
                      privacy: '1',
                      created_at: '2016-01-31 01:59:31.31')
post03 = Post.create!(user_id: '3',   track: '6u9RO91ANrFqD8dmUNiMoc',
											lat:			'51.5296212',		lon:			'-0.1351044',
											dummy_lat:'51.5291844',		dummy_lon:'-0.1385139',
                      message: 'My first kiss was to this song! {tag_1}',
                      place_name: 'Euston Station, London',
                      privacy: '2',
                      created_at: '2016-02-01 00:41:46.46')
post04 = Post.create!(user_id: '4',   track: '3JbqwFY5q0ORO3siv5zL3A',
											lat:			'51.5334212',		lon:			'-0.1278044',
											dummy_lat:'51.5330049',		dummy_lon:'-0.1303199',
                      message: '{tag_7} Send help!',
                      place_name: "Under a train!",
                      privacy: '3',
                      created_at: '2016-02-01 08:12:29.29')
post05 = Post.create!(user_id: '5',   track: '3kguMbJma0qhOLniGsFlKq',
											lat:			'51.5302212',		lon:			'-0.1309544',
											dummy_lat:'51.5292083',		dummy_lon:'-0.1336463',
                      message: 'First they came for the musicians...',
                      place_name: 'Chalton Street, London',
                      privacy: '0',
                      created_at: '2016-02-01 12:57:36.36')
post06 = Post.create!(user_id: '6',   track: '7B04VRtTs6ucHp8qJ6Nz8M',
											lat:			'51.5311820',		lon:			'-0.1310650',
											dummy_lat:'51.5291138',		dummy_lon:'-0.1301796',
...
post07 = Post.create!(user_id: '7',   track: '1jUPOeAOtsjjV1jUWc2H1g',
											lat:			'34.09800110',		lon:		'-118.327731',
											dummy_lat:'34.0976120',		dummy_lon:'-118.3285183',
                      message: 'The only good songs are hymns!',
                      place_name: "The ArcLight, Hollywood",
                      privacy: '2',
                      created_at: '2016-02-03 08:35:05.05')
post08 = Post.create!(user_id: '8',   track: '4DbUk1qwcz9KKcUY4t8f8u',
											lat:			'34.0980050',		lon:			'-118.333672',
											dummy_lat:'34.0983177',		dummy_lon:'-118.3315550',
                      message: 'That\'s a good song!',
                      place_name: "Earwolf Studios",
                      privacy: '3',
                      created_at: '2016-02-03 07:17:46.46')
post09 = Post.create!(user_id: '9',   track: '6ofOBTBzzjjvOOm3iMmLiE',
											lat:			'90.0',		lon:			'0.0',
											dummy_lat:'90.0',		dummy_lon:'0.0',
                      message: 'Ho HO!',
                      place_name: "The North Pole",
                      privacy: '0',
                      created_at: '2016-02-03 20:44:10.10')
post10 = Post.create!(user_id: '10',  track: '1ZtzjvhIcLoogzOpt4rKoa',
											lat:			'33.9879300',		lon:			'-118.421295',
											dummy_lat:'33.9886647',		dummy_lon:'-118.4195756',
                      message: 'WOMP UP THE JAMZ!',
                      place_name: "Marina del Rey High School",
                      privacy: '1',
                      created_at: '2016-02-04 12:27:22.22')
post11 = Post.create!(user_id: '11',  track: '14WWzenpaEgQZlqPq2nk4v',
											lat:			'51.523368',		lon:			'-0.144278',
											dummy_lat:'51.522679',		dummy_lon:'-0.141259',
...
post12 = Post.create!(user_id: '12',  track: '2vDT1uU6hZgdp3PbWGr0Xy',
											lat:			'51.530176',		lon:			'-0.120847',
											dummy_lat:'51.527938',		dummy_lon:'-0.117493',
...
post13 = Post.create!(user_id: '13',  track: '7vfWgVGiLgnGbInU5lvSQg',
											lat:			'51.519336',		lon:			'-0.125997',
											dummy_lat:'51.518569',		dummy_lon:'-0.126000',
                      message: 'Seeing your own mechanism starts to transform it.',
                      place_name: "The British Museum",
                      privacy: '0',
                      created_at: '2016-02-05 07:37:55.55')
post14 = Post.create!(user_id: '14',  track: '0IKK48xF4eEdfofyaeKWWO',
											lat:			'51.509187',		lon:			'-0.160586',
											dummy_lat:'51.510479',		dummy_lon:'-0.157312',
...
post15 = Post.create!(user_id: '15',  track: '0SJPThTy7ynySPF4euczx7',
											lat:			'51.508813',		lon:			'-0.127027',
											dummy_lat:'51.510217',		dummy_lon:'-0.125326',
...
post16 = Post.create!(user_id: '16',  track: '3hB5DgAiMAQ4DzYbsMq1IT',
											lat:			'51.507638',		lon:			'-0.096557',
											dummy_lat:'51.509258',		dummy_lon:'-0.097934',
...
post17 = Post.create!(user_id: '17',  track: '3CRDbSIZ4r5MsZ0YwxuEkn',
											lat:			'51.525050',		lon:			'-0.087459',
											dummy_lat:'51.524240',		dummy_lon:'-0.084315',
...
post18 = Post.create!(user_id: '18',  track: '40YcuQysJ0KlGQTeGUosTC',
											lat:			'51.507264',		lon:			'-0.075356',
											dummy_lat:'51.506869',		dummy_lon:'-0.072843',
...
post19 = Post.create!(user_id: '10',  track: '1brwdYwjltrJo7WHpIvbYt',
											lat:			'51.513247',		lon:			'-0.132005',
											dummy_lat:'51.513087',		dummy_lon:'-0.131826',
...
post20 = Post.create!(user_id: '10',  track: '6OZh916QF8XNunWaP97WEZ',
											lat:			'51.500906',		lon:			'-0.142991',
											dummy_lat:'51.501122',		dummy_lon:'-0.143643',
...
post21 = Post.create!(user_id: '5',  track: '69bp2EbF7Q2rqc5N3ylezZ',
											lat:			'51.492731',		lon:			'-0.157668',
											dummy_lat:'51.492703',		dummy_lon:'-0.154282',
...
post22 = Post.create!(user_id: '4',  track: '0L7loeTIg6akW84aEQZpCT',
											lat:			'51.518268',		lon:			'-0.174834',
											dummy_lat:'51.520105',		dummy_lon:'-0.172066',
...
post23 = Post.create!(user_id: '8',  track: '27SdWb2rFzO6GWiYDBTD9j',
											lat:			'51.498716',		lon:			'-0.174920',
											dummy_lat:'51.499884',		dummy_lon:'-0.173306',
...
post24 = Post.create!(user_id: '6',  track: '3vv9phIu6Y1vX3jcqaGz5Z',
											lat:			'51.476963',		lon:			'0.001290',
											dummy_lat:'51.475978',		dummy_lon:'0.001242',
                      message: 'If someone screams at you externally, it is your own internal part screaming.',
                      place_name: "Royal Observatory Greenwich",
                      privacy: '3',
                      created_at: '2016-02-12 09:53:17.17')
post25 = Post.create!(user_id: '10',  track: '6T506SFlFUVVNvnmCiVZR0',
											lat:			'51.513781',		lon:			'-0.099647',
											dummy_lat:'51.515674',		dummy_lon:'-0.097429',
                      message: 'A request for forgiveness confirms guilt.',
                      place_name: "St. Paul's Cathedral, London",
                      privacy: '0',
                      created_at: '2016-02-12 12:02:53.53')
post26 = Post.create!(user_id: '14',  track: '3jomjC6H7YQBRr2CHPtc4y',
											lat:			'51.512285',		lon:			'-0.123336',
											dummy_lat:'51.513269',		dummy_lon:'-0.124998',
                      message: 'Your notions of good and evil are relative.',
                      place_name: "Covent Garden",
                      privacy: '1',
                      created_at: '2016-02-13 11:05:17.17')
post27 = Post.create!(user_id: '6',  track: '0r4SsYcwvd8URat6AS2m6f',
											lat:			'51.503097',		lon:			'-0.118186',
											dummy_lat:'51.503963',		dummy_lon:'-0.118868',
                      message: 'The only sin is not to be aware.',
                      place_name: "London Eye",
                      privacy: '2',
                      created_at: '2016-02-14 03:41:46.46')
post28 = Post.create!(user_id: '6',  track: '2Aa1wE8ofs2tu59TOQrZKW',
											lat:			'51.498555',		lon:			'-0.127713',
											dummy_lat:'51.499966',		dummy_lon:'-0.127696',
...
post29 = Post.create!(user_id: '14',  track: '1i1fxkWeaMmKEB4T7zqbzK',
											lat:			'51.494548',		lon:			'-0.144708',
											dummy_lat:'51.495254',		dummy_lon:'-0.145023',
...
post30 = Post.create!(user_id: '1',  track: '1WP1r7fuvRqZRnUaTi2I1Q',
											lat:			'51.519363',		lon:			'-0.147712',
											dummy_lat:'51.519600',		dummy_lon:'-0.150426',
...
post31 = Post.create!(user_id: '13',  track: '3CJvmtWw2bJsudbAC5uCQk',
											lat:			'51.508252',		lon:			'-0.148827',
											dummy_lat:'51.508298',		dummy_lon:'-0.146172',
                      message: "To fight fear is to enforce it.",
                      place_name: "29 Hill St",
                      privacy: '2',
                      created_at: '2016-02-16 14:54:14.14')
post32 = Post.create!(user_id: '3',  track: '3pzjHKrQSvXGHQ98dx18HI',
											lat:			'51.498368',		lon:			'-0.140287',
											dummy_lat:'51.497628',		dummy_lon:'-0.143452',
...
post33 = Post.create!(user_id: '12',  track: '2I5Z2JIIQX9d5XCOLDk8wx',
											lat:			'51.504381',		lon:			'-0.016819',
											dummy_lat:'51.502415',		dummy_lon:'-0.015567',
...
post34 = Post.create!(user_id: '9',  track: '53Y0kdCa1CZ9gRqEuknfwy',
											lat:			'51.479566',		lon:			'-0.062172',
											dummy_lat:'51.478205',		dummy_lon:'-0.059317',
                      message: "Fear is a hidden desire.",
                      place_name: "Commercial Way, London",
                      privacy: '1',
                      created_at: '2016-02-18 01:33:36.36')
post35 = Post.create!(user_id: '13',  track: '7gBj0VgcuAgkXkiRRYvSmK',
											lat:			'51.481900',		lon:			'-0.155252',
											dummy_lat:'51.481406',		dummy_lon:'-0.151870',
                      message: "Loss of fear is loss of life.",
                      place_name: "Battersea Park, UK",
                      privacy: '2',
                      created_at: '2016-02-18 02:42:43.43')
post36 = Post.create!(user_id: '15',  track: '2Fn3coxd0xAZ09JtrgcgHa',
											lat:			'51.498781',		lon:			'-0.177367',
											dummy_lat:'51.498590',		dummy_lon:'-0.174938',
                      message: "Fear is fuel human's ego works on.",
                      place_name: "Ayrton Rd, London",
                      privacy: '3',
                      created_at: '2016-02-18 12:07:12.12')
post37 = Post.create!(user_id: '7',  track: '3RiPr603aXAoi4GHyXx0uy',
											lat:			'51.531281',		lon:			'-0.177367',
											dummy_lat:'51.531505',		dummy_lon:'-0.178041',
...
post38 = Post.create!(user_id: '1',  track: '5tf1VVWniHgryyumXyJM7w',
											lat:			'51.538975',		lon:			'-0.141509',
											dummy_lat:'51.537669',		dummy_lon:'-0.142128',
                      message: "See that what you are afraid of, you already have.",
                      place_name: "Greenland Rd, Camden",
                      privacy: '1',
                      created_at: '2016-02-19 15:25:55.55')
post39 = Post.create!(user_id: '8',  track: '37R0bQOQj5a7DOqh1TGzvB',
											lat:			'51.535556',		lon:			'-0.103277',
											dummy_lat:'51.534787',		dummy_lon:'-0.102777',
...
post40 = Post.create!(user_id: '2',  track: '0NmeI6UpRE27dxxgosD5n9',
											lat:			'51.533846',		lon:			'-0.072417',
											dummy_lat:'51.533833',		dummy_lon:'-0.074215',
...
post41 = Post.create!(user_id: '7',  track: '0WEVf4RhIrcr3S3ULBrt0T',
											lat:			'51.526462',		lon:			'-0.101278',
											dummy_lat:'51.528389',		dummy_lon:'-0.102154',
                      message: "Holistic seeing is action",
                      place_name: "Harold Laski House, London",
                      privacy: '0',
                      created_at: '2016-02-21 09:23:02.02')
post42 = Post.create!(user_id: '6',  track: '7xT0GApaXGNVMUdRx2taZv',
											lat:			'51.505236',		lon:			'-0.124392',
											dummy_lat:'51.503135',		dummy_lon:'-0.124009',
...
post43 = Post.create!(user_id: '3',  track: '04Hd3SxnL6b41B4ClPtmtq',
											lat:			'51.507180',		lon:			'-0.095781',
											dummy_lat:'51.506521',		dummy_lon:'-0.096528',
                      message: "You cannot change what you do not see.",
                      place_name: "133 Park St, London, UK",
                      privacy: '2',
                      created_at: '2016-02-22 11:08:10.10')
post44 = Post.create!(user_id: '9',  track: '69uxyAqqPIsUyTO8txoP2M',
											lat:			'51.495126',		lon:			'-0.108400',
											dummy_lat:'51.493048',		dummy_lon:'-0.107252',
...
post45 = Post.create!(user_id: '8',  track: '68fXn0TVggt7Gr0sPbBuI5',
											lat:			'51.507414',		lon:			'-0.058424',
											dummy_lat:'51.505940',		dummy_lon:'-0.055830',
                      message: "There is only one constant in life: change.",
                      place_name: "21 Wapping Ln, UK",
                      privacy: '0',
                      created_at: '2016-02-23 10:49:26.26')
post46 = Post.create!(user_id: '4',  track: '1UfBAJfmofTffrae5ls6DA',
											lat:			'51.511093',		lon:			'-0.088387',
											dummy_lat:'51.512511',		dummy_lon:'-0.087202',
                      message: "There can be no winners in your fight with yourself.",
                      place_name: "100 Cannon St",
                      privacy: '1',
                      created_at: '2016-02-23 21:59:02.02')
post47 = Post.create!(user_id: '8',  track: '6TaqooOXAEcijL6G1AWS2K',
											lat:			'51.515021',		lon:			'-0.204307',
											dummy_lat:'51.515644',		dummy_lon:'-0.205265',
...
post48 = Post.create!(user_id: '5',  track: '0PAj9Y5kFEzhGeWkockoxv',
											lat:			'51.530202',		lon:			'-0.203700',
											dummy_lat:'51.528695',		dummy_lon:'-0.206696',
                      message: "One can fight for health only if one happens to be sick.",
                      place_name: "London, UK",
                      privacy: '3',
                      created_at: '2016-02-25 18:25:55.55')
post49 = Post.create!(user_id: '10',  track: '7ilS0BPWS8ek2P2GaxH3cP',
											lat:			'51.521215',		lon:			'-0.119582',
											dummy_lat:'51.519449',		dummy_lon:'-0.117591',
                      message: "Disease is a result of your notion of yourself.",
                      place_name: "London",
                      privacy: '0',
                      created_at: '2016-02-25 18:36:00.00')
post50 = Post.create!(user_id: '6',  track: '6RsWqX8zABZLhZydXxEFOm',
											lat:			'51.511848',		lon:			'-0.135969',
											dummy_lat:'51.510661',		dummy_lon:'-0.136269',
...
post51 = Post.create!(user_id: '16',  track: '7crplFzt7spG80NCbpmuCp',
											lat:			'51.511848',		lon:			'-0.130628',
											dummy_lat:'51.510908',		dummy_lon:'-0.130931',
...
post52 = Post.create!(user_id: '18',  track: '22mek4IiqubGD9ctzxc69s',
											lat:			'51.509053',		lon:			'-0.128079',
											dummy_lat:'51.510839',		dummy_lon:'-0.130078',
                      message: "Asserting on side of the truth, you lie in relationship to the whole.",
                      place_name: "London, UK",
                      privacy: '3',
                      created_at: '2016-02-27 03:44:38.38')
post53 = Post.create!(user_id: '14',  track: '25khomWgBVamSdKw7hzm3l',
											lat:			'51.508600',		lon:			'-0.146408',
											dummy_lat:'51.507721',		dummy_lon:'-0.146467',
                      message: "Love your enemy, as he is you.",
                      place_name: "Hay's Mews, UK",
                      privacy: '0',
                      created_at: '2016-02-28 02:05:17.17')
post54 = Post.create!(user_id: '1',  track: '6splO3UF8hSmK33y5fJTNk',
											lat:			'51.506484',		lon:			'-0.137304',
											dummy_lat:'51.507610',		dummy_lon:'-0.140874',
...
post55 = Post.create!(user_id: '18',  track: '7fPHfBCyKE3aVCBjE4DAvl',
											lat:			'51.505956',		lon:			'-0.128929',
											dummy_lat:'51.504154',		dummy_lon:'-0.126181',
                      message: "That is reinforced what we pay attention to?",
                      place_name: "Admiralty House, London",
                      privacy: '2',
                      created_at: '2016-02-28 18:12:58.58')
post56 = Post.create!(user_id: '14',  track: '66hayvUbTotekKU3H4ta1f',
											lat:			'51.507995',		lon:			'-0.146044',
											dummy_lat:'51.506928',		dummy_lon:'-0.144076',
                      message: "I was born to live, not please everyone!",
                      place_name: "Clarges Mews",
                      privacy: '3',
                      created_at: '2016-02-29 07:26:24.24')
post57 = Post.create!(user_id: '1',  track: '46gjYTEK7W8ZTABcglGP2f',
											lat:			'51.515172',		lon:			'-0.135847',
											dummy_lat:'51.515238',		dummy_lon:'-0.137760',
                      message: "And they lived happily and often ever after!",
                      place_name: "Kleins",
                      privacy: '0',
                      created_at: '2016-02-29 23:42:43.43')
post58 = Post.create!(user_id: '18',  track: '1HNkqx9Ahdgi1Ixy2xkKkL',
											lat:			'51.514568',		lon:			'-0.128443',
											dummy_lat:'51.515476',		dummy_lon:'-0.125714',
                      message: "Nothing poisons life more than potassium cyanide...",
                      place_name: "The Phoenix Garden",
                      privacy: '1',
                      created_at: '2016-03-01 21:53:17.17')
post59 = Post.create!(user_id: '3',  track: '3pXF1nA74528Edde4of9CC',
											lat:			'51.516532',		lon:			'-0.138639',
											dummy_lat:'51.515609',		dummy_lon:'-0.137585',
...
post60 = Post.create!(user_id: '12',  track: '2ZRJRe82aZaVhOKKlbJr4v',
											lat:			'51.514266',		lon:			'-0.114484',
											dummy_lat:'51.515484',		dummy_lon:'-0.112071',
                      message: "We only live once. I couldn't bear a second time!",
                      place_name: "Carey St, London",
                      privacy: '3',
                      created_at: '2016-03-02 01:21:31.31')
post61 = Post.create!(user_id: '1',  track: '71SDPonZOsIKNtqnaX8LXj',
											lat:			'51.515248',		lon:			'-0.124923',
											dummy_lat:'51.514652',		dummy_lon:'-0.127887',
                      message: "1/7 of our lives are Mondays :S ",
                      place_name: "The Covent Garden CBT Practice",
                      privacy: '0',
                      created_at: '2016-03-02 09:02:53.53')
post62 = Post.create!(user_id: '6',  track: '46THN9jjPWhSqFUu6YsBhv',
											lat:			'51.514492',		lon:			'-0.120917',
											dummy_lat:'51.515719',		dummy_lon:'-0.123057',
                      message: "Living is good. But Id prefer to live good somewhere else...",
                      place_name: "Block H",
                      privacy: '1',
                      created_at: '2016-03-02 18:37:26.26')
post63 = Post.create!(user_id: '3',  track: '4wFHfY9IILHLNwakPuFogD',
											lat:			'51.512604',		lon:			'-0.113392',
											dummy_lat:'51.512876',		dummy_lon:'-0.116385',
                      message: "Nerve cells are born and die; fat cells live forever!",
                      place_name: "Essex St",
                      privacy: '2',
                      created_at: '2016-03-03 10:35:02.02')
post64 = Post.create!(user_id: '13',  track: '34gCuhDGsG4bRPIf9bb02f',
											lat:			'51.503613',		lon:			'-0.112299',
											dummy_lat:'51.501760',		dummy_lon:'-0.108800',
...
post65 = Post.create!(user_id: '17',  track: '1dl3vuXJS9anUXE7XnNP75',
											lat:			'51.507240',		lon:			'-0.113756',
											dummy_lat:'51.508082',		dummy_lon:'-0.115787',
...
post66 = Post.create!(user_id: '17',  track: '7x5xYW5W42OGPAdHUyyguy',
											lat:			'51.507920',		lon:			'-0.106715',
											dummy_lat:'51.510029',		dummy_lon:'-0.109497',
                      message: "Live as someone has left an open gate for you.",
                      place_name: "Sea Containers House",
                      privacy: '1',
                      created_at: '2016-03-05 22:56:38.38')
post67 = Post.create!(user_id: '17',  track: '40EB7ABUO6MoWMUwPKptJ7',
											lat:			'51.507542',		lon:			'-0.109871',
											dummy_lat:'51.507044',		dummy_lon:'-0.111807',
                      message: "Life is short.\n\n\nHave a bit of patience.",
                      place_name: "Studio 6 Restaurant, London",
                      privacy: '2',
                      created_at: '2016-03-06 06:47:31.31')
post68 = Post.create!(user_id: '17',  track: '494OU6M7NOf4ICYb4zWCf5',
											lat:			'51.507240',		lon:			'-0.093121',
											dummy_lat:'51.509333',		dummy_lon:'-0.093357',
...
post69 = Post.create!(user_id: '10',  track: '0wdKiSBUT7aZkXUIdJWcwC',
											lat:			'51.510488',		lon:			'-0.093485',
											dummy_lat:'51.509247',		dummy_lon:'-0.092792',
...
post70 = Post.create!(user_id: '11',  track: '43PuMrRfbyyuz4QpZ3oAwN',
											lat:			'51.519553',		lon:			'-0.113634',
											dummy_lat:'51.518634',		dummy_lon:'-0.110988',
...
post71 = Post.create!(user_id: '13',  track: '6oDkCmfVcSd9NXAKk1b4Ll',
											lat:			'51.512906',		lon:			'-0.146286',
											dummy_lat:'51.512778',		dummy_lon:'-0.146473',
...
post72 = Post.create!(user_id: '10',  track: '71EnloViXmSKrQkrkaYFxF',
											lat:			'51.503613',		lon:			'-0.145194',
											dummy_lat:'51.503784',		dummy_lon:'-0.145895',
...
post73 = Post.create!(user_id: '10',  track: '0P6RjFd2HgG2AXJadQuGfE',
											lat:			'51.499155',		lon:			'-0.145801',
											dummy_lat:'51.500442',		dummy_lon:'-0.148232',
...
post74 = Post.create!(user_id: '11',  track: '2H8LPaY3NSjmOFMH2Rygnz',
											lat:			'51.500591',		lon:			'-0.152113',
											dummy_lat:'51.498364',		dummy_lon:'-0.152635',
                      message: "Simple rule: do your best; let God do the rest.",
                      place_name: "Halkin St, London, UK",
                      privacy: '1',
                      created_at: '2016-03-10 13:19:12.12')
post75 = Post.create!(user_id: '8',  track: '7vFoFDWqTX0mHzLfrF1Cfy',
											lat:			'51.489860',		lon:			'-0.134876',
											dummy_lat:'51.490874',		dummy_lon:'-0.135651',
                      message: "If the music is too loud, you're probably too old.",
                      place_name: "Pimlico Food & Wine",
                      privacy: '2',
                      created_at: '2016-03-10 21:43:12.12')
post76 = Post.create!(user_id: '10',  track: '0rHVd8h0cFwgLgPFem6S60',
											lat:			'51.503689',		lon:			'-0.133420',
											dummy_lat:'51.502908',		dummy_lon:'-0.130989',
                      message: "I do very bad things extremely well!",
                      place_name: "The Mall",
                      privacy: '3',
                      created_at: '2016-03-11 20:41:17.17')
post77 = Post.create!(user_id: '2',  track: '32OlwWuMpZ6b0aN2RZOeMS',
											lat:			'51.510791',		lon:			'-0.137425',
											dummy_lat:'51.510718',		dummy_lon:'-0.136735',
...
post78 = Post.create!(user_id: '7',  track: '0HMjXBAZmSYOTTi33WpMso',
											lat:			'51.500138',		lon:			'-0.162552',
											dummy_lat:'51.500006',		dummy_lon:'-0.159625',
...
post79 = Post.create!(user_id: '15',  track: '0L6UCE1Y0KX3MF2AtxlntI',
											lat:			'51.594092',		lon:			'-0.146044',
											dummy_lat:'51.594309',		dummy_lon:'-0.145810',
                      message: "Shit happens; flush it down and move on!",
                      place_name: "Buckingham Palace Rd, London, UK",
                      privacy: '2',
                      created_at: '2016-03-13 05:55:41.41')
post80 = Post.create!(user_id: '7',  track: '66CFbqJScx6zRieGllITcs',
											lat:			'51.504921',		lon:			'-0.196587',
											dummy_lat:'51.503315',		dummy_lon:'-0.197114',
                      message: "Friday is my second favourite F word.",
                      place_name: "Hornton St",
                      privacy: '3',
                      created_at: '2016-03-13 06:56:10.10')
post81 = Post.create!(user_id: '6',  track: '6ZllZRW9urRfEUdmtMM3lE',
											lat:			'51.500426',		lon:			'-0.178875',
											dummy_lat:'51.499892',		dummy_lon:'-0.177240',
                      message: "If not us, who? I not now, when?",
                      place_name: "Metric Bar",
                      privacy: '0',
                      created_at: '2016-03-13 13:58:05.05')
post82 = Post.create!(user_id: '7',  track: '664gdARxaClFsoF5SXKOws',
											lat:			'51.537560',		lon:			'-0.145903',
											dummy_lat:'51.537887',		dummy_lon:'-0.146536',
                      message: "The power of imagination makes us infinite!",
                      place_name: "The Dublin Castle",
                      privacy: '1',
                      created_at: '2016-03-14 04:48:00.00')
post83 = Post.create!(user_id: '6',  track: '0ZogPPD0uFaPXVhlZJOtSK',
											lat:			'51.523320',		lon:			'-0.116882',
											dummy_lat:'51.523252',		dummy_lon:'-0.120134',
                      message: "In teaching others we teach ourselves.",
                      place_name: "Doughty St, London",
                      privacy: '2',
                      created_at: '2016-03-14 10:13:26.26')
post84 = Post.create!(user_id: '2',  track: '6WhzFzROw3aq3rPWjgYlxr',
											lat:			'51.492283',		lon:			'-0.225199',
											dummy_lat:'51.490811',		dummy_lon:'-0.227073',
                      message: "You must do the thing you THINK you cannot do.",
                      place_name: "Hammersmith, London, UK",
                      privacy: '3',
                      created_at: '2016-03-14 19:12:00.00')
post85 = Post.create!(user_id: '3',  track: '62vpWI1CHwFy7tMIcSStl8',
											lat:			'51.538577',		lon:			'-0.132551',
											dummy_lat:'51.539486',		dummy_lon:'-0.130166',
...
post86 = Post.create!(user_id: '10',  track: '6DUdDIRgLqCGq1DwkNWQTN',
											lat:			'51.533831',		lon:			'-0.047941',
											dummy_lat:'51.532490',		dummy_lon:'-0.047167',
                      message: "Life is trying things to see if they work.",
                      place_name: "Sewardstone Rd",
                      privacy: '1',
                      created_at: '2016-03-15 19:35:02.02')
post87 = Post.create!(user_id: '4',  track: '3G2grVPTDrTQskKKsoEnRA',
											lat:			'51.526470',		lon:			'-0.087862',
											dummy_lat:'51.528259',		dummy_lon:'-0.085918',
...
post88 = Post.create!(user_id: '7',  track: '3kfxarilcBr81mb2hmZLeh',
											lat:			'51.490671',		lon:			'-0.129008',
											dummy_lat:'51.492033',		dummy_lon:'-0.130364',
                      message: "The best way out is always through -> !",
                      place_name: "Atterbury St, London, UK",
                      privacy: '3',
                      created_at: '2016-03-17 10:17:46.46')
post89 = Post.create!(user_id: '18',  track: '5iNRPN7oYQvdB9AmeSW6d3',
											lat:			'51.518234',		lon:			'-0.121787',
											dummy_lat:'51.516045',		dummy_lon:'-0.120240',
                      message: "I hear and I forget.\nI see and I remember.\nI do and I understand.",
                      place_name: "Southampton Pl",
                      privacy: '0',
                      created_at: '2016-03-17 19:39:22.22')
post90 = Post.create!(user_id: '6',  track: '5cKhVlFn0Kuq68V56lSLvW',
											lat:			'51.515775',		lon:			'-0.116882',
											dummy_lat:'51.516846',		dummy_lon:'-0.117020',
                      message: "Wherever you go, go with all your heart.",
                      place_name: "Lincoln's Inn Fields",
                      privacy: '1',
                      created_at: '2016-03-18 17:38:24.24')
post91 = Post.create!(user_id: '9',  track: '4VrWlk8IQxevMvERoX08iC',
											lat:			'51.523744',		lon:			'-0.105983',
											dummy_lat:'51.522424',		dummy_lon:'-0.109314',
                      message: "Everything you can imagine is real.",
                      place_name: "St. James's Church Garden",
                      privacy: '2',
                      created_at: '2016-03-19 02:08:10.10')
post92 = Post.create!(user_id: '17',  track: '2YlZnw2ikdb837oKMKjBkW',
											lat:			'51.511196',		lon:			'-0.113204',
											dummy_lat:'51.510625',		dummy_lon:'-0.115068',
...
post93 = Post.create!(user_id: '1',  track: '4sw7dHjD6EsGs0d57AHgdy',
											lat:			'51.514418',		lon:			'-0.121106',
											dummy_lat:'51.515239',		dummy_lon:'-0.117781',
                      message: "The OBSTACLE is the PATH.",
                      place_name: "Drury Lane, London, UK",
                      privacy: '0',
                      created_at: '2016-03-19 16:42:14.14')
post94 = Post.create!(user_id: '15',  track: '5NQbUaeTEOGdD6hHcre0dZ',
											lat:			'51.514927',		lon:			'-0.153942',
											dummy_lat:'51.514783',		dummy_lon:'-0.151307',
                      message: "Men are born to succeed, not fail.",
                      place_name: "Edwards Mews",
                      privacy: '1',
                      created_at: '2016-03-20 07:13:26.26')
post95 = Post.create!(user_id: '3',  track: '5a7NdkF09AfD0H607eiOkX',
											lat:			'51.523490',		lon:			'-0.052165',
											dummy_lat:'51.521793',		dummy_lon:'-0.049716',
                      message: "Whatever you are, be a good one.",
                      place_name: "Lang St",
                      privacy: '2',
                      created_at: '2016-03-20 14:38:24.24')
post96 = Post.create!(user_id: '12',  track: '7oGZAicScQt96OAW4AruYy',
											lat:			'51.525524',		lon:			'-0.063201',
											dummy_lat:'51.526953',		dummy_lon:'-0.065142',
                      message: "May you live every day of your life.",
                      place_name: "Kelsey St",
                      privacy: '3',
                      created_at: '2016-03-20 22:14:53.53')
post97 = Post.create!(user_id: '10',  track: '1tYt8PbpbeTuqsNmprAZYY',
											lat:			'51.528830',		lon:			'-0.083910',
											dummy_lat:'51.527362',		dummy_lon:'-0.086151',
                      message: "If you have never failed, you have never lived.",
                      place_name: "Yours Food Centre",
                      privacy: '0',
                      created_at: '2016-03-21 15:27:22.22')
post98 = Post.create!(user_id: '8',  track: '6Wytqpe4mfmyeT8s1xbczG',
											lat:			'51.496779',		lon:			'-0.090587',
											dummy_lat:'51.494969',		dummy_lon:'-0.090603',
...
post99 = Post.create!(user_id: '6',  track: '6ZANrVuAMp2rpjhfbOuJly',
											lat:			'51.492028',		lon:			'-0.115929',
											dummy_lat:'51.493644',		dummy_lon:'-0.115395',
...
postA0 = Post.create!(user_id: '8',  track: '4ja3m5fYLcugwuXB6Jkh4Y',
											lat:			'51.539763',		lon:			'-0.003661',
											dummy_lat:'51.540610',		dummy_lon:'-0.002342',
